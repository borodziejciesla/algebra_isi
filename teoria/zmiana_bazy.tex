...
Każdy wektor "nowej" bazy może być przedstawiony jako kombinacja liniowa wektorów "starej" bazy:
$$\mathbf{e}'_{j} = \sum_{i=1}^{n}{p_{ji}\mathbf{e}_{i}} = \begin{bmatrix} \mathbf{e}_{1} & \mathbf{e}_{2} & \cdots & \mathbf{e}_{n} \end{bmatrix} \begin{bmatrix} p_{11} \\ p_{21} \\ \vdots \\ p_{n1} \end{bmatrix}$$.
